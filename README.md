...
| **Ver 4.5** | **보상 체계 개편** | **월 50시간 학습 시 대여권 지급**, **상점 대여권 구매 제한**, **커스텀 예외(`ErrorCode`)** 도입 |
...
### 4. 학습 보상 시스템 (Gamification) - Ver 4.5 [UPDATED] ⭐
...
* **내 정보 조회:** `GET /v4/users/me` (패널티, 아이템, **월간 학습 시간** 포함)
* **출석 체크:** `POST /v4/users/attendance` (코인 획득)
