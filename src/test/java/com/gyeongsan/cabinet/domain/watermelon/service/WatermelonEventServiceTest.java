...
class WatermelonEventServiceTest {
    ...
    @Mock private WatermelonRepositoryPort watermelonRepository;

    @Mock private WatermelonEventLogRepositoryPort logRepository;

    @Mock private UserRepositoryPort userRepository;

    @InjectMocks private WatermelonEventService watermelonEventService;
    ...
    void buyItem_insufficientCoins() {
        ...
        given(watermelonRepository.findByUserId(1L))
                .willReturn(Optional.of(Watermelon.createNew(1L)));
    ...
    void enhance_dangerousFertilizerLevelLimit() {
        Watermelon level7Wm =
                Watermelon.builder().userId(1L).currentLevel(7).dangerousFertilizerCount(5).build();
    ...
    void applyEnhancement_dropProtectionSuccess() {
        Watermelon wm =
                Watermelon.builder().userId(1L).currentLevel(5).dropProtectionCount(2).build();
    ...
    void applyEnhancement_destroyProtectionSuccess() {
        Watermelon wm =
                Watermelon.builder().userId(1L).currentLevel(5).destroyProtectionCount(3).build();
