package com.gyeongsan.cabinet.adapter.in.web.calendar;

import com.gyeongsan.cabinet.adapter.in.web.calendar.dto.*;
...
public class CalendarEventController {
    ...
    public ApiResponse<List<CalendarEventResponseDto>> getEvents(
        ...
        return ApiResponse.success(calendarUseCase.getEvents(start, end));
    }
    ...
    public ApiResponse<MessageResponse> createEvent(
        ...
        calendarUseCase.createEvent(userPrincipal.getUserId(), request);
    ...
    public ApiResponse<MessageResponse> updateEvent(
            @PathVariable Long eventId, @RequestBody CalendarEventRequestDto request) {
        calendarUseCase.updateEvent(eventId, request);
    ...
    public ApiResponse<MessageResponse> deleteEvent(@PathVariable Long eventId) {
        calendarUseCase.deleteEvent(eventId);
