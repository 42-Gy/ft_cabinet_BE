...
import com.gyeongsan.cabinet.alarm.SlackBotService; // 👇 [추가] DM 서비스 import
...
public class LentScheduler {
    ...
    private final SlackBotService slackBotService; // 👇 [추가] 봇 서비스 주입
    ...
    public void checkOverdue() {
        ...
        for (LentHistory lh : overdueLents) {
            ...
            // 봇에게 DM 발송 명령
            slackBotService.sendDm(userEmail, message);

            log.warn("🚨 연체 적발! DM 발송 요청 완료: {}", userEmail);
        }
    }
}